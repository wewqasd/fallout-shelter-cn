...
与 write_back_v5_1.py 的 parse_terms 同逻辑，输出 notes/new_version_terms_full.json 同格式。
...
def main():
    ...
    out = sys.argv[2] if len(sys.argv) > 2 else os.path.join(_ROOT, "data", "new_version_terms_full.json")
